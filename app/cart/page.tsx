    ...
    return (
      <div className="min-h-screen pt-[73px] flex items-center justify-center px-6">
        <div className="text-center">
          <ShoppingBag size={36} strokeWidth={1} className="mx-auto mb-8 text-black/15 dark:text-white/15" />
          <p className="text-[10px] tracking-[0.3em] text-black/35 dark:text-white/35 mb-5">YOUR BAG</p>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex items-center">
                        <button
                          ...
                          className="w-8 h-8 border border-black/20 dark:border-white/20 hover:border-black dark:hover:border-white text-sm transition-colors"
                          aria-label="Decrease"
                        >
                          −
                        </button>
