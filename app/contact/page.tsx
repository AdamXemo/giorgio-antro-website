        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="order-2 lg:order-1 space-y-14">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={label} className="flex gap-5">
                    <Icon size={15} strokeWidth={1.5} className="flex-shrink-0 mt-0.5 text-black/30" />
                    <div>
                      <p className="text-[9px] tracking-[0.22em] text-black/30 mb-1.5">{label}</p>
                      {href ? (
                        <a
                          href={href}
            ...
            <div className="border-t border-black/10 pt-10">
              ...
              <div className="space-y-2 text-sm text-black/45 leading-relaxed">
          ...
          <div className="order-1 lg:order-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full bg-black text-white py-4 text-[10px] tracking-[0.28em] border border-black hover:bg-white hover:text-black transition-colors duration-300 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-black disabled:hover:text-white"
              >
