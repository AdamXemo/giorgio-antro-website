      ...
      <div className="pt-[73px] min-h-screen flex flex-col">
        ...
        <div className="max-w-sm w-full px-6 py-12 text-center">
          <div className="flex items-center justify-center mb-10 animate-reveal-fade">
            <AlertCircle size={48} strokeWidth={0.75} className="text-black/30" />
          </div>
          <p className="text-[9px] tracking-[0.35em] text-black/28 mb-4 animate-reveal-fade animate-delay-100">PAYMENT {redirectStatus === 'failed' ? 'FAILED' : 'INCOMPLETE'}</p>
          ...
          <div className="w-6 h-px bg-black/18 mx-auto mb-5 animate-reveal-fade animate-delay-300" />
          <p className="text-sm text-black/40 leading-relaxed animate-reveal-fade animate-delay-300">
  ...
  return (
    <div className="pt-[73px]">
      <div className="max-w-sm mx-auto px-6 pt-12 pb-24 text-center">
        ...
        <div className="flex items-center justify-center mb-10 animate-reveal-fade">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
            ...
            <path
              ...
              className="text-black/40 animate-draw-check animate-delay-300"
            />
          </svg>
        </div>

        <p className="text-[9px] tracking-[0.35em] text-black/28 mb-4 animate-reveal-fade animate-delay-100">ORDER CONFIRMED</p>
        <h1 className="font-display font-light text-4xl md:text-5xl leading-[1.1] mb-5 animate-reveal-up animate-delay-200">
        ...
        {/* Info rows */}
        <div className="mt-8 pt-8 border-t border-black/[0.07] space-y-4 text-left animate-reveal-fade animate-delay-400">
          <div className="flex items-start gap-3 text-sm text-black/45">
            <Mail size={13} strokeWidth={1.5} className="flex-shrink-0 mt-[3px] text-black/22" />
            <p>A confirmation email with your order details is on its way.</p>
          </div>
          <div className="flex items-start gap-3 text-sm text-black/45">
            <Package size={13} strokeWidth={1.5} className="flex-shrink-0 mt-[3px] text-black/22" />
            <p>Processed and shipped within 1–2 business days.</p>
          </div>
        </div>

        {/* Steps */}
        <div className="mt-8 pt-8 border-t border-black/[0.07] animate-reveal-fade animate-delay-500">
          <p className="text-[9px] tracking-[0.3em] text-black/22 mb-6">WHAT HAPPENS NEXT</p>
          <div className="space-y-0">
            {[
              ...
              <div key={n} className="flex items-baseline gap-4 py-3 border-b border-black/[0.06] last:border-0 text-left">
                <span className="text-[9px] text-black/18 tabular-nums w-5 flex-shrink-0">{n}</span>
                <span className="text-xs font-medium w-20 flex-shrink-0">{label}</span>
                <span className="text-xs text-black/38">{body}</span>
              </div>
            ))}
          </div>
        </div>
