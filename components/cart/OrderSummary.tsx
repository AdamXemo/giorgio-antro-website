  ...
  return (
    <div className="border-t border-black pt-8 lg:sticky lg:top-24">
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="border-t border-black/10 pt-5 flex justify-between items-baseline">
      ...
      <Link
        href="/checkout"
        className="w-full bg-black text-white py-4 text-[10px] tracking-[0.3em] font-light flex items-center justify-center gap-3 border border-black hover:bg-white hover:text-black transition-colors duration-300 mb-4"
      >
