            ...
            <ScrollReveal key={label} delay={i * 90}>
              <div className="flex gap-5 group">
                <Icon
                  size={15}
                  strokeWidth={1.5}
                  className="flex-shrink-0 mt-0.5 text-black/30 group-hover:text-black transition-colors duration-300"
                />
                <div>
                  <p className="text-[9px] tracking-[0.22em] text-black/30 mb-1.5">
                    {label}
                  </p>
                  {href ? (
                    <a
